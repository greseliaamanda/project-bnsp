<div id="content" class="p-4 p-md-5 pt-5">
    ...
    <hr>
    <iframe src="arsip/<?php echo $r_tampil_arsip['file_surat'];; ?>" style="width: 100%;height: 500px;"></iframe>
    <button type="button" class="tombol"><a href="index.php?p=arsip" style="color:black">Kembali</a>
    <button type="button" class="tombol"><a href="http://localhost/bnsp-greselia/arsip/<?php echo $file?>" style="color:black">Unduh</a>
